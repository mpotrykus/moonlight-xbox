...
void InitializeToastService(Grid^ rootGrid) {
    ...
    kfX1->KeyTime = KeyTime{ TimeSpan{ 3000000LL } }; // 0.3s
    kfX1->Value = 0.0;
    ...
    kfX2->KeyTime = KeyTime{ TimeSpan{ 23000000LL } }; // 2.3s
    kfX2->Value = 0.0;

    auto kfX3 = ref new EasingDoubleKeyFrame();
    kfX3->KeyTime = KeyTime{ TimeSpan{ 28000000LL } }; // 2.8s
    kfX3->Value = 400.0;
    ...
    kfOp1->KeyTime = KeyTime{ TimeSpan{ 2500000LL } }; // 0.25s
    kfOp1->Value = 1.0;
    ...
    kfOp2->KeyTime = KeyTime{ TimeSpan{ 23000000LL } }; // 2.3s
    kfOp2->Value = 1.0;

    auto kfOp3 = ref new EasingDoubleKeyFrame();
    kfOp3->KeyTime = KeyTime{ TimeSpan{ 28000000LL } }; // 2.8s
    kfOp3->Value = 0.0;
