#pragma once
#include "UI\Backgrounds\StreaksBackground.g.h"
#include <vector>
#include <random>
...
struct StreakState {
    float t;        // along-diagonal position: x_center + y_center
    float lane;     // cross-diagonal position: x_center - y_center
    float halfLen;  // half-length in diagonal space
    float speed;    // dt per frame
    float glowH;    // glow rectangle height (stroke thickness)
