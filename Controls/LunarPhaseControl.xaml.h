...
#include "Controls\LunarPhaseControl.g.h"
...
namespace moonlight_xbox_dx {
    ...
    public:
        ...
        // ShadowCenterX must be public so Storyboard can target it by name
    ...
    private:
        ...
        Windows::UI::Xaml::Media::Animation::Storyboard^ m_scaleStoryboard;
    };
}
